...
Lists
    ...
    module.exports={same:same,today:today,
    sum: sum, int: int, id: id, rand: rand, 
    any: any, d2:d2, p2:p2, s4:s4, 
    xray: xray, zero1: zero1, clone:clone,
    say:say,soy: soy, last: last, 
    Order: Order}
